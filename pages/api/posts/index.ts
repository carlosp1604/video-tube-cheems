...
import {
  CreatePostCommentApiRequestValidatorError
} from '../../../modules/Posts/Infrastructure/Validators/CreatePostCommentApiRequestValidatorError'
...
export default async function handler(
  ...
  let apiRequest
  try {
    apiRequest = JSON.parse(request.body)
  }
...
function handleValidationError(
  request: NextApiRequest,
  response: NextApiResponse,
  validationError: CreatePostCommentApiRequestValidatorError
) {
